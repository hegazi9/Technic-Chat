...
const Chat = ({route , navigation }) => {
 ...
 const sendMsg = (message) => {
  ...
  const _videoCalling = () => {
    navigation.navigate('AgoraVideo');
  };

  const _voiceCalling = () => {
    navigation.navigate('AgoraVoice');
  };
  ...
  const _keyExtractor = index => index + Math.random();
      ...
      <View style={styles.headerView}>
        ...
        <View style={styles.callingView}>
          ...
          <View style={styles.rowIcons}>
            <TouchableOpacity style={styles.backgroundIconPhone}  onPress = {()=> _voiceCalling()} >
